...
function NavItem({ menu, ...props }: LinkProps) {
	...
	let icon = menu.icon && <div className="menu-icon"><i className={menu.icon} title={menu.title}></i></div>;
	...
	let title = menu.title && <div className="menu-text" title={menu.title}>{menu.title} {label} {highlight}</div>;
	...
	render() {
		return (
			<div className="menu">
				...
				<div className="menu-header" id="menu-header">Menu de Navegação</div>
