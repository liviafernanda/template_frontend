    ...
    return (
      <div className="navbar-item dropdown">
        ...
        <div className="dropdown-menu dropdown-menu-end">
          ...
          <a href="#/" className="dropdown-item">
            <span className="flag-icon flag-icon-cn me-2" title="cn"></span> Chinese
          </a>
          <a href="#/" className="dropdown-item">
            <span className="flag-icon flag-icon-jp me-2" title="jp"></span> Japanese
          </a>
          <a href="#/" className="dropdown-item">
            <span className="flag-icon flag-icon-be me-2" title="be"></span> Belgium
          </a>
