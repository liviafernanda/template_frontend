                  ...
                  <div className="row mb-3">
                      ...
                      <ul className="nav d-block fw-bold">
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> FontAwesome
                          </a>
                        </li>
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Ionicons
                          </a>
                        </li>
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Simple Line
                            Icons
                          </a>
                        </li>
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Typography
                          </a>
                        </li>
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Media Object
                          </a>
                        </li>
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Widget Boxes
                          </a>
                        </li>
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Tabs &
                            Accordions
                          </a>
                        </li>
                      </ul>
                    ...
                    <div className="col-lg-6">
                      <ul className="nav d-block fw-bold">
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Unlimited
                            Nav Tabs
                          </a>
                        </li>
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Modal &
                            Notification
                          </a>
                        </li>
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Buttons
                          </a>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <ul className="nav d-block fw-bold">
                        ...
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Page with
                            Footer <span className="badge bg-success py-1">NEW</span>
                          </a>
                        </li>
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Page without
                            Sidebar
                          </a>
                        </li>
                        <li>
                    ...
                    <div className="col-lg-6">
                      <ul className="nav d-block fw-bold">
                        <li>
                          <a href="#/" className="text-ellipsis text-dark text-decoration-none">
                            <i className="fa fa-chevron-right fa-fw text-gray-500"></i> Full Height
                            Content
                          </a>
                        </li>
                        <li>
